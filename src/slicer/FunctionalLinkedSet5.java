...
public class FunctionalLinkedSet5<T> extends FunctionalLinkedSet4<T> {


	private static final long serialVersionUID = 1L;
	protected Set<T> set5;
	
	protected FunctionalLinkedSet5(
			Set<T> set1, 
			Set<T> set2,
			Set<T> set3,
			Set<T> set4,
  ...
  @Override
	public void addElements(List<Set<T>> list) {
		super.addElements(list); list.add(set5);
	}

	@Override	
	public void resetLinks() {
		set1 = set2 = set3 = set4 = set5 = null;
	}
