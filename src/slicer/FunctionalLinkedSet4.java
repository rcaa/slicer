...
public class FunctionalLinkedSet4<T> extends FunctionalLinkedSet3<T> {
	
	private static final long serialVersionUID = 1L;
	protected Set<T> set4;
	
	protected FunctionalLinkedSet4(
			Set<T> set1, 
			Set<T> set2,
			Set<T> set3,
			Set<T> set4) {
		super(set1, set2, set3);
		this.set4 = set4;
	}
	
	@Override
	public void addElements(List<Set<T>> list) {
		super.addElements(list); list.add(set4);
	}
